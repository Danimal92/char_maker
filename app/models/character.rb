class Character < ApplicationRecord
    ...
    validates :int, :str, :dex, :cha, :wis, :con, numericality: {greater_than_or_equal_to: 8}
    belongs_to :user
    belongs_to :race
    belongs_to :job
    has_many :characters_spells
    has_many :spells, through: :characters_spells, :dependent => :destroy
    has_many :characters_skills
    has_many :skills, through: :characters_skills, :dependent => :destroy
